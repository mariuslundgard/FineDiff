...
class OpcodesTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertTrue(is_a(new Opcodes, 'Diff\Parser\OpcodesInterface'));
    }
    ...
    {
        $operation = m::mock('Diff\Parser\Operations\Copy');
    ...
    /**
     * @expectedException Diff\Exceptions\OperationException
     */
    ...
    {
        $operation_one = m::mock('Diff\Parser\Operations\Copy');
        $operation_one->shouldReceive('getOpcode')->andReturn('c5i');

        $operation_two = m::mock('Diff\Parser\Operations\Copy');
